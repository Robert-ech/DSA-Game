...
- Inside a castle: **Mario-style level path**, 10 nodes connected by a winding dotted trail. Nodes 1 to 9 completed nodes show a flag, current node pulses, future nodes are dim.
